### This script presents our modifications to the TIMM.Models.factory script
...
def create_model(
    ...
    if source_name == 'hf_hub':
        ...
        kwargs['external_default_cfg'] = hf_default_cfg  #  revamp default_cfg interface someday

    kwargs['file_name'] = os.path.join(checkpoint_path,model_name+ext)
    ...
    if checkpoint_path:
        load_checkpoint(model, kwargs.pop('file_name'))
